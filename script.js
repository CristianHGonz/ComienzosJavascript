...
alert(
  "Bienvenido, tenes 3 intentos para logear tu cuenta de lo contrario sera bloqueada"
);
let logueado = false;
...
function login() {
  for (let i = 1; i <= 3; i++) {
    ...
    if (usuarioIngresado === usuario && passwordIngresado === password) {
      alert(`Bienvenido ${usuario}, podes empezar a comprar`);
      return true;
    } else {
  ...
  if (!logueado) {
    alert("Tu cuenta se bloqueo por demasiados intentos fallidos");
  }
}
    ...
    switch (carrito) {
      case 1:
        do {
          ...
          switch (limpieza) {
            case 1:
              productoLimpieza = agregarProducto(
                productoLimpieza,
                500,
                "Jabon en polvo"
              );
                ...
                if (confirm("¿Desea quitar un producto?")) {
                  ...
                  switch (limpieza) {
                    case 1:
                        if(jabonEnPolvo > 0 ){
                      jabonEnPolvo--;
                      productoLimpieza = quitarProducto(productoLimpieza, 1500, "Jabon en Polvo")
                    }
                      else{
                          alert("No puede quitar un producto q no compraste");
                    }
                      break;
                    case 2:
                              if(suavizante > 0 ){
                    ...
                    case 4:
                      alert(
                        `En Productos de Limpieza gastate $ ${productoLimpieza}`
                      );
                      break;
                    default:
                ...
                if (confirm("¿Desea quitar un producto?")) {
                  ...
                  switch (almacen) {
                   ...
                   if(yerba > 0 ){
                    ...
                    case 4:
                      alert(
                        `En productos de Almacen gastate $${productoAlmacen}`
                      );
                      break;
                    default:
                      alert("Opción ingresada incorrecta");
      ...
      case 3:
        do {
          ...
          switch (perfumeria) {
            case 1:
              productoPerfumeria = agregarProducto(
                productoPerfumeria,
                10000,
                "Perfume"
              );
            ...
            if (perfume > 0) {
    perfume--;
    productoLimpieza = quitarProducto(productoLimpieza, 10000, "Perfume");
} else {
    alert("No puede quitar un producto q no compraste");
}
break
                    ...
                    case 4:
                      alert(
                        `En productos de Perfumeria gastate $${productoPerfumeria}`
                      );
                      break;
                    default:
                      alert("Opción ingresada incorrecta");
